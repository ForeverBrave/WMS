...
public class CacheAspect {
    ...
    private static final String POINTCUT_DEPT_GET = "execution(* com.it.sys.service.impl.DeptServiceImpl.getById(..))";
    ...
    public Object cacheDeptGet(ProceedingJoinPoint joinPoint)throws Throwable{
        ...
        if (res1 != null) {
            ...
            log.info("未从缓存里面找到部门对象，请去数据库查询并放入缓存"+CACHE_DEPT_PROFIX+res2.getId());
            return res2;
        }
    }
    ...
    //声明切面表达式
    private static final String POINTCUT_USER_ADD = "execution(* com.it.sys.service.impl.UserServiceImpl.save(..))";
    private static final String POINTCUT_USER_UPDATE = "execution(* com.it.sys.service.impl.UserServiceImpl.updateById(..))";
    private static final String POINTCUT_USER_GET = "execution(* com.it.sys.service.impl.UserServiceImpl.getById(..))";
    private static final String POINTCUT_USER_DELETE = "execution(* com.it.sys.service.impl.UserServiceImpl.removeById(..))";
    ...
    public Object cacheUserGet(ProceedingJoinPoint joinPoint)throws Throwable{
        ...
        Integer arg = (Integer) joinPoint.getArgs()[0];
        //从缓存里面取
        Object res1 = CACHE_CONTAINER.get(CACHE_USER_PROFIX + arg);
        if (res1 != null) {
            ...
            log.info("未从缓存里面找到用户对象，请去数据库查询并放入缓存"+CACHE_USER_PROFIX+res2.getId());
            return res2;
        }
    }
